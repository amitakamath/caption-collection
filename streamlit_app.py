...
def main():
    ...
    st.sidebar.write("- *What are the **positions and relative positions** of the objects?*")
    st.sidebar.write("- *What **definitely** happened **before or after** this picture was taken?*")
    st.sidebar.write("- *What is **definitely not true** about this image?*")
    st.sidebar.write(" ")
